...
public class VerticalGuard : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        direction = 0;
        locations[0] = new Vector2(transform.position.x, transform.position.y + 5);
        locations[1] = new Vector2(transform.position.x, transform.position.y - 5);
    }
    void FixedUpdate()
    {
    ...
    //Rotates the guard to its next position
    void ApplyRotate()
    {
